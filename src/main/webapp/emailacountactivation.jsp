...
<title>Account activatio page</title>
...
<div class="signup-form container" >
	...
	<h2 >Enter code that was sent to your email</h2>

	
       

    <s:form  action="accountActivateAction" cssClass="mx-auto mt-4" method="POST" >
		...
		<s:submit  type="button" value="verify email"/>
    </s:form>
