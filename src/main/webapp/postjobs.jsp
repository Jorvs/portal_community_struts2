...
<div class="signup-form container" >
	...
	<h2 >Registration Form</h2>
		...
		<s:textfield name="job_salary" label="Job Salary"  ></s:textfield>
		<s:select name="type_of_work" label="type of work" list="{'On site','Remote'}" ></s:select>
		<s:textfield name="job_location" label="Job Location" ></s:textfield>
        ...
        <s:textarea name="posted_jobs" label="addition information" ></s:textarea>
		
        
		<s:submit  type="button" value="Post Jobs"/>
		</s:form>
